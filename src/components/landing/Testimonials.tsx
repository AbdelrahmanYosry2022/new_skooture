        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          {testimonials.map((testimonial: any, index: number) => (
            <motion.div
              ...
              className="group relative p-8 rounded-2xl bg-[#191919]/60 backdrop-blur-md border border-border hover:border-[#00a86b]/30 transition-all duration-500 flex flex-col h-full overflow-hidden"
            >
