        ...
        <div className="flex items-center justify-between">
          ...
          <a href="#" className="flex items-center gap-3 shrink-0">
            {content?.brand?.logoUrl ? (
              ...
              <>
                <div className="theme-brand-icon w-8 h-8 rounded-lg flex items-center justify-center text-foreground font-bold text-sm shrink-0">
          ...
          <div className="hidden lg:flex items-center justify-end gap-6 shrink-0">
            ...
            <Link to="/admin" className="text-[15px] font-medium text-foreground transition-colors hover:text-[color:var(--accent)]">
              {t({ en: 'Login', ar: 'تسجيل الدخول' })}
            </Link>
            
             <a href="#contact" onClick={(e) => handleNavClick(e, '#contact')}>
               <Button className="theme-button-primary px-5 py-[10px] rounded-[8px] font-semibold text-[15px] transition-all duration-200 border-0 h-auto">
