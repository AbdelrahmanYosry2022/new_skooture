      ...
      <div className="theme-panel rounded-[24px] overflow-hidden">
        ...
        <div className="p-6 md:p-8 border-b border-border flex items-center justify-between bg-muted/40">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="text-xl font-bold tracking-tight text-foreground mb-1">{t("sectionHeaders.testimonialsTitle", "Testimonials")}</h4>
              <p className="text-sm text-muted-foreground">{t("sectionHeaders.testimonialsDesc", "Manage customer reviews and feedback.")}</p>
            </div>
          </div>
          ...
          <AnimatePresence mode="wait">
            {activeItem ? (
              ...
              <div className="text-center py-20 border border-dashed border-border rounded-[24px] bg-muted/50">
                <MessageSquareQuote className="w-16 h-16 text-foreground/5 mx-auto mb-4" />
