      ...
      <div className="theme-panel rounded-[24px] overflow-hidden">
        ...
        <div className="p-6 md:p-8 border-b border-border flex items-center justify-between bg-muted/40">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="text-xl font-bold tracking-tight text-foreground mb-1">{t("sectionHeaders.tractionTitle", "Traction & Stats")}</h4>
              <p className="text-sm text-muted-foreground">{t("sectionHeaders.tractionDesc", "Manage the core numbers that represent your impact.")}</p>
            </div>
          </div>
          ...
          {isHeaderExpanded && (
            ...
            >
              <div className="p-6 md:p-8 grid grid-cols-1 gap-6 max-w-5xl">
                 <p className="text-sm text-muted-foreground">No global header settings for this section.</p>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
          ...
          <AnimatePresence mode="wait">
            {activeStat ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-[120px_1fr] gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="theme-focus-accent w-full bg-card border border-border focus:bg-muted text-foreground rounded-[16px] px-5 py-4 transition-all placeholder:text-foreground/10 text-center"
                        placeholder="0"
                      />
                    </div>
                    <div>
              ...
              <div className="text-center py-20 border border-dashed border-border rounded-[24px] bg-muted/50">
                <Activity className="w-16 h-16 text-foreground/5 mx-auto mb-4" />
